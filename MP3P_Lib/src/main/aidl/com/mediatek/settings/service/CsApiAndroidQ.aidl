...
interface CsApiAndroidQ {
    	...
    	void openScan();
    	String getScanInfo();
    //test nobug add for api screen shot yuanrongwang 2019-12-2 begin
    	/*screenShot*/
    	void screenShot();
    //test nobug add for api screen shot yuanrongwang 2019-12-2 end

    //no bug add API androidBeam functions yuanrongwang 2019-12-3 begin
    	/*AndroidBeam*/
    	boolean enableAndroidBeam() ;
        boolean disableAndroidBeam() ;
    //no bug add API androidBeam functions yuanrongwang 2019-12-3 end

        /*unknow source*/
    	boolean enableUnknownSourceNew();
    	boolean disableUnknownSourceNew();

    //test nobug add for api cleanSdCardStorage yuanrongwang 2019-12-2 begin
    	/*cleansdcardstorage*/
    	void cleanSdCardStorage();
    //test nobug add for api cleanSdCardStorage yuanrongwang 2019-12-2 end

    //test nobug add for api bluebooth yuanrongwang 2019-12-2 begin
    	/*bluebooth*/
    	void enableBluetooth();
    	void disableBluetooth();
    	List<String> getDevicePairList();
        List<String> getDeviceUnPairList();
    	void connectToBluetooth(int i);
    //test nobug add for api bluebooth yuanrongwang 2019-12-2 end
       ...
       //scan once or more
        ...
        //enable or disable UseUsbFor
        void enableUseUsbFor(String useUsbFor);
        void disableUseUsbFor(String useUsbFor);
